...
class DiseaseReport(Base):
    ...
    image     = relationship("CropImage", back_populates="disease_reports")
    # ── FIX: was relationship("Advisory", ...) which pointed to wrong mapper ──
    advisories = relationship(
        "Advisory",
        back_populates="disease_report",
        lazy="noload",
    )
...
class Advisory(Base):
    ...
    # ── FIX: correct back_populates pointing to DiseaseReport.advisories ──
    disease_report = relationship(
        "DiseaseReport",
        back_populates="advisories",
        foreign_keys=[disease_report_id],
        lazy="noload",
    )
